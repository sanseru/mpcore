...
<!-- <link rel="stylesheet" href="<?php echo Yii::getAlias('@web') . 'inc/' . $boxFolder; ?>shoutbox.css" type="text/css"> -->
<table border="0" style="width: 100%;height:100%" cellspacing="0" cellpadding="0">
	<form name="fShout" action="<?php echo Yii::getAlias('@web') . 'inc/' . $boxFolder; ?>shout.php" target="ShoutBox" method="post">
		<input type="hidden" name="sbID" value="<?php echo $_SESSION['msgID']; ?>">
		<input type="hidden" name="admin">
		<input type="hidden" name="sbSpr" class="cssSpr" maxlength="20" autocomplete="off">
		<tr valign="top">
			<?php
			...
			?>
				<td>
					<iframe name="ShoutBox" src="<?php echo Yii::getAlias('@web') . 'inc/' . $boxFolder; ?>shout.php" class="cssShoutBox" width="<?php echo $boxWidth; ?>" height="<?php echo $boxHeight; ?>" frameborder="0"></iframe>
				</td>
				<?php
	...
	?>
	<td>
		<table border="0" cellspacing="0" cellpadding="0" width="<?php echo $boxWidth; ?>">
			<tr>
				<td class="cssShoutText"><?php echo $msg['name']; ?>:</td>
				<td align="right"><input type="text" name="sbName" maxlength="20" value="<?php echo Yii::$app->user->identity->username ?>" class="cssShoutForm" style="width:<?php echo $boxWidth ?>"></td>
			</tr>
			<tr>
				<?php
				if (!$hideEmail) {
				?>
					...
					<td align="right"><input type="text" name="sbEMail" maxlength="75" class="cssShoutForm" style="width:<?php echo $boxWidth ?>"></td>
			</tr>
			<tr>
			<?php
				}
			...
			<td colspan="2">
				...
				if ($sendWithEnterKey) {
				?>
					<input name="sbText" style="width:<?php echo $boxWidth; ?>;" class="cssShoutForm" onKeyUp="checkKeyCode(event)" />
				<?php
				} else {
				?>
					<textarea name="sbText" rows="3" style="width:<?php echo $boxWidth; ?>; height:<?php echo $txtHeight; ?>" wrap="virtual" class="cssShoutForm"></textarea>
				<?php
				}
				?>
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr>
						...
						<td align="right" class="p-3"><input type="button" name="Shout" value="<?php echo $msg['shout']; ?>" class="btn btn-primary" onClick="this.disabled=true; shoutIt()"></td>
					</tr>
				</table>
			</td>
			</tr>
	...
	?>
		...
		?>
		<td>
			<iframe name="ShoutBox" src="<?php echo $boxFolder; ?>shout.php" class="cssShoutBox" width="<?php echo $boxWidth; ?>" height="<?php echo $boxHeight; ?>" frameborder="0"></iframe>
		</td>
	<?php
	}
	?>

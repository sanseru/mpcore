...
$this->registerJs("
    ...
    function serverside() {
        tableApiServerSide('.pengiriman','api/admin-pengiriman');
...
function residiterimakembali(id) {
    Swal.fire({
        title: 'Are you sure? Resi Diterima Kembali',
        ...
        if (result.value) {
            $.post('/api/resikembali', {
                ...
                function(data) {
                    ...
                    $('#status'+id+'').removeClass('badge-success').addClass('badge-info');
                    $('#status'+id+'').text('Done ( Selesai )');
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" data-toggle="modal" data-target="#modal-export" class="btn btn-info btn-xs float-right">Export</button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">

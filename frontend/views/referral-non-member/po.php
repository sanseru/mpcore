...
<div class=" card card-orange">
    <div class="card-header">
        <h3 class="card-title">Input Data PO</h3>
    </div>
    <div class=" card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <?= $form->field($model, 'nomer_po')->textInput(['maxlength' => true]) ?>

                <?= $form->field($model, 'remarks_tim_procurement')->textarea(['rows' => 6]) ?>
            </div>
        </div>
        <input type="checkbox" id="nomer_pr" name="nomer_pr">
        <label for="pr"> Update Semua No PR Yang sama </label><br>

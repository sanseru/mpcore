...
<div class=" card card-teal">
    <div class="card-header">
        <h3 class="card-title">Input Data AP</h3>
    </div>
    <div class=" card-body">
        <div class="row">
            <div class="col-md-12">
                ...
                <?= $form->field($model, 'nomer_ap')->textInput(['maxlength' => true]) ?>

                <?= $form->field($model, 'remark_tim_ap')->textarea(['rows' => 6]) ?>

                <input type="checkbox" id="apinvoice" name="apinvoice">
                <label for="vehicle1"> Update Semua No Invoice Ini</label><br>
                <label for="vehicle1"> Nama Client</label><br>
                <input type="text" id="namaclient" name="namaclient">

 ...
 * @property string|null $covteq
 * 
 */
class ModelReferralNonMemberLog extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['tanggal_terima_berkas', 'tanggal_periksa', 'tanggal_input_link_document', 'tanggal_kirim_dokument_ar_ap', 'tanggal_so_pr', 'created_at', 'update_at', 'created_at_so', 'update_at_so', 'created_at_ar', 'update_at_ar', 'created_at_po', 'update_at_po', 'created_at_ap', 'update_at_ap','covteq',
                'invoicehistory','sohistory','document_file'], 'safe'],
            [['jumlah'], 'number'],
            [['link_dokumen_invoice', 'remarks_tim_billing', 'link_gl', 'remarks_tim_ar', 'remarks_tim_procurement', 'remark_tim_ap','covteq'], 'string'],
            ...
            [['document_file','gl_file'], 'file', 'skipOnEmpty' => true, 'extensions' => 'pdf', 'maxFiles' => 4],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'tanggal_periksa' => 'Tanggal Berobat/ Admission Date',
            'nama_rs' => 'Nama Rs',
